    ...
    <h1>ユーザーサイト</h1>        
        <form method="POST" action="./delete_comp.php">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                <input type="mail" readonly class="form-control <?php if( !empty($errors['mail_adress']) ) echo "border-danger text-danger"; ?>" id="mail" name="mail_adress" value ="<?php echo $user['mail_address'];?>">
                </div>
            </div>
             <div class="row mb-3">
